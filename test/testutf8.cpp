...
#define UTF8_PART3 "的"
    assert(strcmp(fcitx_utils_get_ascii_part(UTF8_PART ASCII_PART), ASCII_PART) == 0);
    assert(strcmp(fcitx_utils_get_ascii_part(ASCII_PART), ASCII_PART) == 0);
    assert(strcmp(fcitx_utils_get_ascii_part(""), "") == 0);
    assert(strcmp(fcitx_utils_get_ascii_part(UTF8_PART2 ASCII_PART2 UTF8_PART3), "") == 0);
    assert(strcmp(fcitx_utils_get_ascii_part(UTF8_PART2 ASCII_PART2 UTF8_PART3 ASCII_PART), ASCII_PART) == 0);
    assert(strncmp(fcitx_utils_get_ascii_partn(UTF8_PART2 ASCII_PART2 UTF8_PART3 ASCII_PART,
