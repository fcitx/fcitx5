...
ZwpInputPanelSurfaceV1::ZwpInputPanelSurfaceV1(zwp_input_panel_surface_v1 *data) : version_(zwp_input_panel_surface_v1_get_version(data)), data_(data, &ZwpInputPanelSurfaceV1::destructor) {
