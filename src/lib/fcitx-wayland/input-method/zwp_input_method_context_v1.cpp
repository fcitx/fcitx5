...
const struct zwp_input_method_context_v1_listener ZwpInputMethodContextV1::listener = {
...
void ZwpInputMethodContextV1::preeditString(uint32_t serial, const char *text, const char *commit) {
    return zwp_input_method_context_v1_preedit_string(*this, serial, text, commit);
}
void ZwpInputMethodContextV1::preeditStyling(uint32_t index, uint32_t length, uint32_t style) {
    return zwp_input_method_context_v1_preedit_styling(*this, index, length, style);
}
void ZwpInputMethodContextV1::preeditCursor(int32_t index) {
    return zwp_input_method_context_v1_preedit_cursor(*this, index);
}
void ZwpInputMethodContextV1::deleteSurroundingText(int32_t index, uint32_t length) {
    return zwp_input_method_context_v1_delete_surrounding_text(*this, index, length);
}
...
void ZwpInputMethodContextV1::keysym(uint32_t serial, uint32_t time, uint32_t sym, uint32_t state, uint32_t modifiers) {
    return zwp_input_method_context_v1_keysym(*this, serial, time, sym, state, modifiers);
}
...
void ZwpInputMethodContextV1::textDirection(uint32_t serial, uint32_t direction) {
