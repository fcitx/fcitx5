...
const struct zwp_input_method_v1_listener ZwpInputMethodV1::listener = {
    [](void *data, zwp_input_method_v1 *wldata, zwp_input_method_context_v1 *id) {
    ...
    [](void *data, zwp_input_method_v1 *wldata, zwp_input_method_context_v1 *context) {
        auto obj = static_cast<ZwpInputMethodV1 *>(data);
        assert(*obj == wldata);
        {
            auto context_ = static_cast<ZwpInputMethodContextV1 *>(zwp_input_method_context_v1_get_user_data(context));
