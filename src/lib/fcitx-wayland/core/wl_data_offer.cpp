...
namespace fcitx {
namespace wayland {
constexpr const char *WlDataOffer::interface;
constexpr const wl_interface *const WlDataOffer::wlInterface;
const uint32_t WlDataOffer::version;
...
WlDataOffer::WlDataOffer(wl_data_offer *data) : version_(wl_data_offer_get_version(data)), data_(data, &WlDataOffer::destructor) {
...
void WlDataOffer::finish() {
    return wl_data_offer_finish(*this);
}
