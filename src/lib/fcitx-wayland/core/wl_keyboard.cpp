...
const struct wl_keyboard_listener WlKeyboard::listener = {
    ...
    [](void *data, wl_keyboard *wldata, uint32_t serial, uint32_t modsDepressed, uint32_t modsLatched,
...
WlKeyboard::WlKeyboard(wl_keyboard *data)
    : version_(wl_keyboard_get_version(data)), data_(data, &WlKeyboard::destructor) {
