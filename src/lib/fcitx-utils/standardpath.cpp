...
void StandardPath::scanFiles(Type type, const std::string &path, std::function<bool(const std::string& fileName, const std::string &dir, bool user)> scanner)
{
...
std::map<std::string, StandardPathFile> StandardPath::openMultipleFilesFilter(Type type, const std::string &path, int flags, std::function<bool(const std::string& path, const std::string &dir, bool user)> filter)
{
