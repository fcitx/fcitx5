...
#define METASTRING_TEMPLATE_16(N, S) \
    ::fcitx::__getChar<0x##N##0>(S) ,::fcitx::__getChar<0x##N##1>(S) ,::fcitx::__getChar<0x##N##2>(S) ,::fcitx::__getChar<0x##N##3>(S) ,\
    ::fcitx::__getChar<0x##N##4>(S) ,::fcitx::__getChar<0x##N##5>(S) ,::fcitx::__getChar<0x##N##6>(S) ,::fcitx::__getChar<0x##N##7>(S) ,\
    ::fcitx::__getChar<0x##N##8>(S) ,::fcitx::__getChar<0x##N##9>(S) ,::fcitx::__getChar<0x##N##A>(S) ,::fcitx::__getChar<0x##N##B>(S) ,\
    ::fcitx::__getChar<0x##N##C>(S) ,::fcitx::__getChar<0x##N##D>(S) ,::fcitx::__getChar<0x##N##E>(S) ,::fcitx::__getChar<0x##N##F>(S)
