...
Option<bool> showInputMethodInformationWhenSwitchIM{
    this, "ShowInputMethodInformationWhenSwitchIM",
...
bool GlobalConfig::showInputMethodInformationWhenSwitchIM() const
{
    FCITX_D();
    return d->behavior->showInputMethodInformationWhenSwitchIM.value();
}
